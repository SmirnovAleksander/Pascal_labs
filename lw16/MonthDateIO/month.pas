...
TYPE
  Months = (NoMonth, JAN, FEB, MAR, APR, MAY, JUN, JUL, AUG, SEP, OCT, NOV, DEC);
VAR 
  M1, M2: Months;
PROCEDURE ReadMonth(VAR FIn: TEXT; VAR Mo: Months);
PROCEDURE WriteMonth(VAR FOut: TEXT; VAR Mo: Months);
